  ...
  return (
    <div className={styles.page}>
      <main className={styles.main}>
        ...
        <article style={{padding:'0 20px'}}>Please contact us for further information on our services at info@smjbcapitalinvestments.com</article>
      </main>
      <footer style={{backgroundColor:'black',flex:1,color:'white',display:'flex',width:'100vw',justifyContent:'space-evenly',alignItems:'center',padding:'20px 0',flexWrap:'wrap'}}>
       <p>Contact us: </p><p>info@smjbcapitalinvestments.com</p>
      </footer>
    </div>
  );
}
